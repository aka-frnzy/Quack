...
const Sidebar = ({ auth }) => {
    const [meh, setMeh] = useState('Home')
    return (
        <>
            <div className='flex flex-col border-r-2 border-solid pl-5 pr-5'>
                ...
                <Link to='/' onClick={() => setMeh("Home")}><SidebarTheming text='Home' Icon={HomeIcon} active={meh == "Home"} /></Link>
                ...
                <Link to='/profile' onClick={() => setMeh('Profile')}><SidebarTheming text='Profile' Icon={AccountCircleIcon} active={meh == "Profile"} /></Link>
